...
//mport { initDatabase, saveMemberAnalysis, markAsSentToSlack, closeDatabase } from './db.js'
...
class SlackAIAgent {
    constructor() {
        ...
        this.slack = new App({
            ...
            signingSecret: process.env.process.env.SLACK_SIGNING_SECRET,
            socketMode: true,
            appToken: process.env.SLACK_APP_TOKEN
        });

        this.webClient = new webClinet(process.env.SLACK_BOT_TOKEN);
    ...
    try {
        ...
        if (response.data.items?.length > 0) {
            ...
            return {
                ...
                content: `${details.data.public_repos} public repositories`,
                type: 'github'
            };
        }
